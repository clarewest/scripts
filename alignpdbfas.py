...
parser.add_option("-f", "--fas", dest="myfasfile", metavar = "FILE" ,help ="fichier fas contenant la sequence")
parser.add_option("-p", "--pdb", dest="mypdbfile" , metavar = "FILE",help ="fichier pdb")
...
blastPath = '/data/'+host+'/west/blast-2.2.17/bin/'
